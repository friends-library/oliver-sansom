...
Oliver Sandom`'s goods seized for not paying the tax as a priest--Removes to Abingdon--Goods
...
It came to pass that this man fell sick and died, and on the 12th ofthe tenth month,

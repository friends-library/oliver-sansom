...
His birth and parentage--Early religious impressions--Convincement and profession of
(he Truth--Marriage--Settles at Boxford--Reasons for not attending Church (so called)--Exercise
about the oath--Conference between a Friend and the Priest--Testimony against tithes--Is
made constable--The primary rule of faith and life--Continued persecutions of the priest--Goods
three times distrained for neglecting to hear divine service (so called).
...
which is the prayer, scope and desire of me, who am
...
which have not served that office since the tenant served it for the messuage I now hold.
...
and intreated me with much importunity.

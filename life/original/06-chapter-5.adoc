...
that so thy affection may be wholly set on things that are eternal.
...
if you will promise and engage that he shall not come hither again,
I will let him go.`"
...
that the kingdom of heaven is at hand, and very nigh unto thee.`"
